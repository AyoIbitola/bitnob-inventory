...
# Chained after the quantity-removal migration, NOT the initial schema. Both
# pointing at '307bbbd210c4' would leave alembic with two heads and
# `alembic upgrade head` would fail with "Multiple head revisions are present".
down_revision: Union[str, Sequence[str], None] = '1e906972bdf0'
